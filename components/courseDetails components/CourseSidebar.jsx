                    ...
                    <div key={sect_i} className='border-b'>
                        ...
                        {opened.includes(sect.id) && <div className='flex flex-col '>
                            {sect.curriculum.map((curr, curr_i) => {
                                return (
                                    <div className={`py-3 px-3 flex items-center ${selected.currId == curr.currId ? 'bg-gray-100 border-2 border-slate-700': 'border-2 border-white'} justify-between`} onClick={()=>setSelected(curr)} key={curr_i}>
